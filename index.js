...
// const YT_DLP_PATH = path.join(__dirname, 'yt-dlp'); // Linux-friendly
// const DOWNLOAD_DIR = path.join(__dirname, 'videos');
// const FRONTEND_DIR = path.join(__dirname, 'frontend');
...
app.post('/api/download', (req, res) => {
  ...
  // yt-dlp command with ffmpeg location and output template
  const command = `"${YT_DLP_PATH}" --ffmpeg-location "${FFMPEG_PATH}" -f bestvideo+bestaudio --merge-output-format mp4 -o "${outputPath}" "${url}"`;
